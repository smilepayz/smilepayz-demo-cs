...
public class PayOutRequestDemo
{
    public static async Task PayOutDemo(string env, string merchantId, string merchantSecret, string privateKey,
        string paymentMethod, string cashAccount, int amount,string name)
    {
        // sandbox 
